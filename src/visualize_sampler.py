...
plot_inertial(sample, title='Gyroscope - Sampler Original', y_label='deg/sec', save=False)
plot_inertial(Sampler100(sample), title='Gyroscope - Sampler 100', y_label='deg/sec', save=False)
plot_inertial(Sampler150(sample), title='Gyroscope - Sampler 150', y_label='deg/sec', save=False)
plot_inertial(Sampler200(sample), title='Gyroscope - Sampler 200', y_label='deg/sec', save=False)
