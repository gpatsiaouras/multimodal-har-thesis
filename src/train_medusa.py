...
def train_and_test(args: argparse.Namespace):
    ...
    # Load medusa network
    model = Medusa(param_config.get('general').get('mlp_out_size'))
    ...
    train_losses, val_losses, val_accuracies, train_accuracies, last_step = train_triplet_loss(model, criterion, optimizer,
                                                                                          class_names,
