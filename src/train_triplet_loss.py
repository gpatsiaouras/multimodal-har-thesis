...
if __name__ == '__main__':
    ...
    parser.add_argument('--not_pretrained', action='store_false', dest='pretrained',
                        help='Only for mobilenet disable pretrained state')
    parser.set_defaults(no_scheduler=False, semi_hard=None, verbose=True, pretrained=None)
